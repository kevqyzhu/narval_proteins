...
def get_metrics(mol):
    best_models_outputs = os.path.join(os.path.dirname(__file__), f"../../../../results_compiled/selfies_rnn/{mol}/outputs")
    best_models_metrics = os.path.join(os.path.dirname(__file__), f"../../../../results_compiled/selfies_rnn/{mol}/metrics")
